...
page = st.sidebar.selectbox("Choose a dashboard", ["Home", "Overview", "Channel View",  "Client Segment View", "Lives Covered View", "Closed Sales View","Sales Team View", "Sales vs Target View"])
