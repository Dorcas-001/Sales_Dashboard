...
page = st.sidebar.selectbox("Choose a dashboard", ["Home", "Overview", "Closed Sales View", "Sales vs Target View", "Sales Team View", "Product View", "Channel View",  "Client Segment View", "Lives Covered View"])
